...
var utilisateurs_model_1 = require("../../src/app/models/utilisateurs.model");
var AuthController = /** @class */ (function () {
    function AuthController() {
    }
    AuthController.hello = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, res.status(200).send('hello world')];
        });
    }); };
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    userRepository = typeorm_1.getRepository(utilisateurs_model_1.UtilisateursModel);
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
